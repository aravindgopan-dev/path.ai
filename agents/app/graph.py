...
from app.agents.roadmap_agent import roadmap_node
...
def build_roadmap_graph():
    g = StateGraph(ProjectState)
    g.add_node("roadmap_planner", roadmap_node)
    g.set_entry_point("roadmap_planner")
    g.add_edge("roadmap_planner", END)
    return g.compile()
